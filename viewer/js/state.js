...
const dom = {
  ...
  btnDropdownTrackTools: document.getElementById('btn-dropdown-track-tools'),
  btnDropdownMapOptions: document.getElementById('btn-dropdown-map-options'),
  btnMenuToggleExtrema: document.getElementById('btn-menu-toggle-extrema'),
  lblMenuExtrema: document.getElementById('lbl-menu-extrema'),
